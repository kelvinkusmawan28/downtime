      ...
      <div class="card modern-card">
        ...
        <div class="card-header-status">
          <div class="d-flex align-items-center">
            ...
            <div>
              <h6 class="mb-0 text-danger">Mesin <?= $detail['mach_no']; ?></h6>
              <small class="text-danger"><?= $detail['mach_name']; ?></small>
            </div>
          </div>
          <div>
            <?php if ($detail['status'] == 0) : ?>
              <span class="badge status-badge bg-primary shadow-sm text-white">ON PROGRESS</span>
            <?php else : ?>
              <span class="badge status-badge bg-success shadow-sm text-white">COMPLETED</span>
            <?php endif; ?>
          </div>
        </div>
