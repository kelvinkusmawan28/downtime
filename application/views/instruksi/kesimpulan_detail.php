<form action="<?php echo base_url('instruksi/update_kesimpulan_detail/' . $id_halaman); ?>" method="post" enctype="multipart/form-data">
    <div class="col-12">
        <label for="tgl" class="form-label font-kecil">Keterangan</label>
