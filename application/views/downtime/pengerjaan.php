      ...
      <div class="card h-100">
        ...
        <div class="card-body font-kecil ">
          ...
          <div class="table-responsive">
            <table id="pengerjaanTable" class="tabel datatable">
              <thead>
                <tr>
                  <th>No</th>
                  <th>Departemen</th>
                  <th>Mesin</th>
                  <th>Spek Mesin</th>
                  <th>Hitungan Permenit</th>
                  <th>Hitungan Perjam/Hari</th>
                </tr>
              </thead>
              <tbody>
...
<script>
  $(document).ready(function() {
    var table = $('#pengerjaanTable').DataTable({
      processing: true,
      serverSide: true,
      stateSave: true,
      ajax: {
        url: "<?= base_url('downtime_mesin/filter_pengerjaan') ?>",
        type: "POST",
        data: function(d) {
