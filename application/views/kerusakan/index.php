                ...
                <div class="card-body font-kecil ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3" style="padding-top: 15px; text-align:right;">
                            <a href="<?= base_url('kerusakan/reset_filter') ?>" class="btn btn-primary  font-kecil">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#tambahdata").click(function(e) {
            ...
            const url = "<?= base_url('kerusakan/tambahdata/'); ?>" + filter_dept;
        ...
        $(document).on('click', '.edit', function() {
            ...
            if (data) {
                ...
                $("#loadforminput-edit").load("<?= base_url(); ?>kerusakan/edit/" + encodeURIComponent(data));
            } else {
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#kerusakanTable').DataTable({
            ...
            stateSave: true,
            ajax: {
                url: "<?= base_url('kerusakan/filter_kerusakan') ?>",
                type: "POST",
                data: function(d) {
