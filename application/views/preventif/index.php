            ...
            <div class="card h-100">
                ...
                <div class="card-body font-kecil ">
                    ...
                    <div class="table-responsive">
                        <table id="itemTable" class="tabel datatable">
                            <thead>
                                <tr>
                                    <th>No</th>
                            ...
                            <tbody>
                                <?php $no = 0;
                                foreach ($header as $key) : $no++; ?>
                                    <tr>
                                        <td><?= $no; ?></td>
                                        <td><?= $key['kode']; ?></td>
                                        <td><?= $key['keterangan']; ?></td>
                                        <td>
                                            <a href="<?= base_url('preventif/detail/') . $key['id'] ?>" class="btn btn-success btn-sm font-kecil "><span class="ml-1" style="color: aliceblue;"> View </span></a>
                                        </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel1">Input Kode Item Preventif</h5>
...
<script>
    $(document).ready(function() {
        $("#tambahdata").click(function(e) {
            const url = "<?= base_url('preventif/tambahdata/'); ?>";
