        ...
        <div class="col-lg-12 ">
            ...
            <div class="card h-100">
                ...
                <div class="card-body font-kecil ">
                    ...
                    <form action="<?= base_url('cheklist/simpan_mingguan') ?>" method="post">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <?php if ($ada_terlewat) : ?>
                                    <div class="alert alert-warning">
                                        <span style="font-size: 22px;"> ⚠️</span> <b style="color:black;">PERINGATAN CHECKLIST MINGGUAN</b><br>
                                        <ul class="text-danger">
                                            <?php foreach ($minggu_terlewat as $m) : ?>
                                                <li><?= $m ?></li>
                                            <?php endforeach; ?>
                                ...
                                <?php else : ?>
                                    <?php if ($info_cek) : ?>
                                        <div class="text-danger text-center">
                                            ✔ <b>PREVENTIF MINGGUAN SUDAH DI CEK</b><br>
                                            Petugas : <b><?= $info_cek['petugas'] ?></b><br>
                                            Periode :
                                            <b>
                                                Minggu ke-<?= $periode['minggu_ke'] ?>
                                                (<?= format_tanggal_indonesia($periode['awal']) ?>
                                                – <?= format_tanggal_indonesia($periode['akhir']) ?>)
                                            </b><br>
                                            Tanggal cek :
                                            <?= format_tanggal_indonesia($info_cek['tanggal']) ?>
                                        </div>
                                    <?php endif; ?>
...
<script>
    $('#tanggal').change(function() {
        let tgl = $(this).val();
        let url = "<?= base_url('cheklist/mingguan/' . $header['mach_id'] . '/' . $kode['kode']) ?>?tanggal=" + tgl;
