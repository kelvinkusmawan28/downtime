        ...
        <div class="col-lg-12 ">
            ...
            <div class="card h-100">
                ...
                <div class="card-body font-kecil ">
                    ...
                    <form action="<?= base_url('cheklist/simpan_tahunan') ?>" method="post">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <?php if ($ada_terlewat) : ?>
                                    <div class="alert alert-warning">
                                        ⚠️ <b>PERINGATAN CHECKLIST TAHUNAN</b><br>
                                        Checklist berikut belum diisi:
                                        <ul>
                                            <?php foreach ($tahun_terlewat as $t) : ?>
                                                <li><?= $t ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                        ...
                        <div class="row mt-4">
                            ...
                            <?php else : ?>
                                <?php if ($sudah_cek && $info_cek) : ?>
                                    <div class="text-danger text-center">
                                        ✔ <b>PREVENTIF TAHUNAN SUDAH DI CEK</b><br>
...
<script>
    $('#tanggal').change(function() {
        let tgl = $(this).val();
        let url = "<?= base_url('cheklist/enam_bulan/' . $header['mach_id'] . '/' . $kode['kode']) ?>?tanggal=" + tgl;
