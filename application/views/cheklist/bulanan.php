        ...
        <div class="col-lg-12 ">
            ...
            <div class="card h-100">
                ...
                <div class="card-body font-kecil ">
                    ...
                    <form action="<?= base_url('cheklist/simpan_bulanan') ?>" method="post">
                        <div class="row">
                                ...
                                <?php if ($ada_terlewat) : ?>
                                    <div class="alert alert-warning shadow-sm">
                                        <h6 class="font-weight-bold text-danger">
                                            ⚠️ PERINGATAN CHECKLIST BULANAN
                                        </h6>

                                        <p class="mb-2">Checklist berikut belum diisi:</p>

                                        <ul class="mb-0">
                                            <?php foreach ($bulan_terlewat as $b) : ?>
                                                <li><?= $b ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                            ...
                            <?php else : ?>
                                <?php if ($info_cek) : ?>
                                    <div class="text-danger text-center">
                                        ✔ <b>PREVENTIF BULANAN SUDAH DI CEK</b><br>

                                        Petugas :
                                        <b><?= $info_cek['petugas'] ?></b><br>

                                        Bulan :
                                        <b>
                                            <?= format_bulan_indonesia(date('m', strtotime($info_cek['tanggal']))) ?>
                                            <?= date('Y', strtotime($info_cek['tanggal'])) ?>
                                        </b><br>
...
<script>
    $('#tanggal').change(function() {
        let tgl = $(this).val();
        let url = "<?= base_url('cheklist/bulanan/' . $header['mach_id'] . '/' . $kode['kode']) ?>?tanggal=" + tgl;
