        ...
        <div class="col-lg-12 ">
            ...
            <div class="card h-100">
                ...
                <div class="card-body font-kecil ">
                    ...
                    <form action="<?= base_url('cheklist/simpan_enambulan') ?>" method="post">
                        <div class="row">
                                ...
                                <?php if ($ada_terlewat) : ?>
                                    <div class="alert alert-warning shadow-sm">
                                        <h6 class="font-weight-bold text-danger">
                                            ⚠️ PERINGATAN CHECKLIST PER 6 BULAN
                                        </h6>

                                        <p class="mb-2">Checklist berikut belum diisi:</p>

                                        <ul class="mb-0">
                                            <?php foreach ($enambulan_terlewat as $b) : ?>
                                                <li><?= $b ?></li>
                                            <?php endforeach; ?>
                                        </ul>
                                    </div>
                            ...
                            <?php else : ?>
                                <?php if ($sudah_cek) : ?>
                                    <div class="text-danger text-center">
                                        ✔ <b>PREVENTIF PER 6 BULAN SUDAH DI CEK</b><br>
